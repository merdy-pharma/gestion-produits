        ...
        <div className="mb-6">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border border-gray-200 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
              value={searchTerm}
  ...
  <div className="mt-4 space-y-2">
    ...
    <div className="grid grid-cols-3 gap-2">
      ...
      <button
        ...
        className={`p-2 flex flex-col items-center rounded-lg border h-20
          ${selectedPayment === "mobile" ? "border-primary-500 bg-primary-50" : "border-gray-200 dark:border-gray-700"}
        `}
        disabled
      >

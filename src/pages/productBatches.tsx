      ...
      */} 
      ...
      <div className="flex flex-col">
        ...
        <div className="col-span-2 flex gap-2">
          <button className="btn-secondary bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-300 dark:hover:bg-blue-600 transition-colors">
         ...
         className="border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2 text-sm bg-gray-400 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"
        >
          Réinitialiser
        </button>
        </div>

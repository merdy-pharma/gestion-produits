      ...
      */} 
      ...
      <div className="flex flex-col">
        ...
        <div className="col-span-2 flex gap-2">
         ...
         className="border border-gray-500 dark:border-gray-700 rounded-lg px-3 py-2 text-sm bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"
        >
          Réinitialiser
        </button>
        </div>

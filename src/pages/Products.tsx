...
return (
  ...
  <div className="space-y-6 text-gray-800 dark:text-gray-200 transition-colors">
     ...
     {/* <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-3 gap-6 p-4 bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200 min-h-screen transition-colors">  */}
      ...
      <h1 className="text-xl sm:text-2xl font-bold">Tous nos Produits</h1>
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <button
          ...
          className="btn-secondary inline-flex items-center px-4 py-2 rounded-lg hover:bg-purple-700 shadow-sm active:scale-95"
        >
          <PlusCircle size={18} className="mr-2" />
          Gérer les Lots
        </button>
                ...
                <td className="px-4 py-2 flex items-center gap-2">
                  {product.image_url ? (
                    <img src={product.image_url} alt={product.name} className="w-10 h-10 rounded object-cover" />
                      ...
                      <div className="w-10 h-10 bg-gray-200 flex dark:bg-gray-700 justify-center items-center rounded">
  ...
  <div className="bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200 w-full max-w-lg rounded-xl shadow-lg p-6 relative transition-colors">  
            ...
            <form onSubmit={handleFormSubmit} className="space-y-4 text-sm">
              ...
              */}
              ...
              className="w-full bg-green-500 text-white py-2 text-purple-600 rounded "
            >
              Gérer les lots
            </button>

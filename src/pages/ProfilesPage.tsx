              ...
              {profiles.map((p) => (
                ...
                >
                  ...
                  <div className="flex gap-2 flex-wrap">
                    <button
                      onClick={() => openEdit(p)}
                      className="flex-1 flex items-center justify-center gap-1 px-3 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors text-sm font-medium text-gray-800 dark:hover:bg-gray-900"
                    >
                      <Edit size={14} />
                      Éditer
                    </button>

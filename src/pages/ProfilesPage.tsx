...
export default function ProfilesPage() {
  ...
  return (
    <div className="page p-4 md:p-6 max-w-7xl mx-auto">
      <div className="mb-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <Button
            onClick={openNew}
            className="btn-primary flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white"
          >
            <Plus size={18} />
            Nouveau Profil
          </Button>
              ...
              {profiles.map((p) => (
                ...
                >
                  ...
                  <div className="flex gap-2 flex-wrap">
                    <button
                      onClick={() => openEdit(p)}
                      className="flex-1 flex items-center justify-center gap-1 px-3 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors text-sm font-medium text-gray-700 dark:hover:bg-gray-200"
                    >
                      <Edit size={14} />
                      Éditer
                    </button>
                    <button
                      ...
                      className={`btn flex-1 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
                        p.status
            ...
            <div className="mt-6 flex items-center justify-between border-t pt-4">
              <div className="flex gap-2">
                <button
                  ...
                  disabled={page === 1}
                  className="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed dark:hover:bg-gray-600"
                >
                  Précédent
                </button>
                <button

  ...
  return (
    <div className="page">
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          onClick={openCreate}
          className="btn-secondary flex items-center gap-2 px-2 py-1 bg-blue-600 text-white rounded-lg shadow hover:bg-blue-700 transition"
        >
      ...
      {showModal && (
        <div className="modal-overlay">
          <div className="modal max-w-lg w-full">
            ...
            <h3 className="text-lg font-bold mb-4 dark:text-gray-400">{editId ? "Modifier la catégorie" : "Ajouter une catégorie"}</h3>

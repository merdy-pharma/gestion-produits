          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-1 bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 overflow-y-auto h-80 transition-colors">
              ...
              {lowStockProducts.length === 0 ? (
                <p className="text-sm text-gray-500 dark:text-gray-400">Aucun produit en rupture de stock.</p>
              ) : (
                <ul className="space-y-2">
                  {lowStockProducts.map((products_sellable_stock) => (
                    <li key={products_sellable_stock.id} className="flex justify-between border-b border-gray-200 dark:border-gray-700 pb-1">
                      ...
                      <span className={`font-semibold ${products_sellable_stock.sellable_stock === 0 ? 'text-red-600' : ''}`}>
